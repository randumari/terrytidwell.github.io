let WORLD = {
    'chess_room' : {
        ...
        create: (scene) => {
            for (let x = 2; x <= 9; x++) {
                addAlly(scene, x, 8, 'black_pieces', PIECE_SPRITES.PAWN);
                addEnemy(scene, x, 3, 'white_pieces', PIECE_SPRITES.PAWN);
            }
            addEnemy(scene, 2, 2, 'white_pieces', PIECE_SPRITES.ROOK);
            addEnemy(scene, 3, 2, 'white_pieces', PIECE_SPRITES.KNIGHT_DOWN);
            addEnemy(scene, 4, 2, 'white_pieces', PIECE_SPRITES.BISHOP_DOWN);
            addEnemy(scene, 5, 2, 'white_pieces', PIECE_SPRITES.QUEEN);
            addEnemy(scene, 6, 2, 'white_pieces', PIECE_SPRITES.KING_HORIZONTAL);
            addEnemy(scene, 7, 2, 'white_pieces', PIECE_SPRITES.BISHOP_DOWN);
            addEnemy(scene, 8, 2, 'white_pieces', PIECE_SPRITES.KNIGHT_DOWN);
            addEnemy(scene, 9, 2, 'white_pieces', PIECE_SPRITES.ROOK);
            addAlly(scene, 2, 9, 'black_pieces', PIECE_SPRITES.ROOK);
            addGroundSquare(scene, 3, 9);
            addAlly(scene, 4, 9, 'black_pieces', PIECE_SPRITES.BISHOP_UP);
            addAlly(scene, 5, 9, 'black_pieces', PIECE_SPRITES.QUEEN);
            addAlly(scene, 6, 9, 'black_pieces', PIECE_SPRITES.KING_HORIZONTAL);
            addAlly(scene, 7, 9, 'black_pieces', PIECE_SPRITES.BISHOP_UP);
            addAlly(scene, 8, 9, 'black_pieces', PIECE_SPRITES.KNIGHT_UP);
            addAlly(scene, 9, 9, 'black_pieces', PIECE_SPRITES.ROOK);
            //addGroundSquare(scene, 9, 9);
            ...
            //addPawn(scene, 9, 4);
            //addPlayer(scene, 3, 9);
            scene.__character = addPlayerInitial(scene, 3, 9);
